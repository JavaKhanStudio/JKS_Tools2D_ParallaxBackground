...
public class ColorOnTextureBasicTest extends ApplicationAdapter 
{
	...
	public static void main (String[] arg) 
	{
		...
		Lwjgl3Application application = new Lwjgl3Application(new ColorOnTextureBasicTest(), config);
	}
 	...
 	public void create () 
 	{
	    ...
	    for (int x = 0; x < pixmap.getWidth(); x++) 
	    {
	        for (int y = 0; y < pixmap.getHeight(); y++) 
	        {
	        	...
	        	pixmap.drawPixel(x, y,Enum_ColorIsolation.RED.buildFromInteger(pixmap.getPixel(x, y))) ; 
