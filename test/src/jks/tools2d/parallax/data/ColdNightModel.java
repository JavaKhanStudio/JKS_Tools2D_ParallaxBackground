...
public class ColdNightModel
{
	...
	public static ArrayList<Parallax_Model> buildPages() 
	{
		...
		clouds1.regionName = "clouds" ;
		clouds1.sizeRatio = 0.5f ;
		clouds1.regionPosition = 1 ; 
		clouds1.speed = 0.5f ;
		...
		ground0.regionName = "ground" ; 
		ground0.sizeRatio = 0.27f ;
		ground0.regionPosition = 1 ; 
		...
		ground1.regionName = "ground" ; 
		ground1.sizeRatio = 0.32f ;
		ground1.regionPosition = 2 ; 
		...
		ground2.regionName = "ground" ; 
		ground2.sizeRatio = 0.40f ;
		ground2.regionPosition = 1 ; 
		...
		ground4.regionName = "ground" ; 
		ground4.sizeRatio = 0.6f ;
		ground4.regionPosition = 1 ; 
		...
		ground5.regionName = "ground" ; 
		ground5.sizeRatio = 0.6f ;
		ground5.regionPosition = 2 ; 
